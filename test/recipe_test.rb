...
class RecipeTest < Minitest::Test
  ...
  def test_it_starts_without_any_ingredients
  ...
  def test_it_can_find_amount_of_each_ingredient_needed_for_recipe
    @mac_and_cheese.add_ingredient(@cheese, 2)
    @mac_and_cheese.add_ingredient(@mac, 8)
  ...
  def test_it_can_list_the_ingredients_needed_for_recipe
    @mac_and_cheese.add_ingredient(@cheese, 2)
    @mac_and_cheese.add_ingredient(@mac, 8)
    expected = [@cheese, @mac]
